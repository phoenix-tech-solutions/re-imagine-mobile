  ...
  const content = (
    <View className="flex-row items-center justify-between py-3">
      ...
      {rightElement ?? (
        <View className="flex-row items-center">
          {valueText ? (
            <Text className="mr-2 text-sm text-gray-500 dark:text-gray-400">{valueText}</Text>
          ) : null}
...
export default function SettingsScreen() {
  ...
  return (
      ...
      <ScrollView className={theme == "dark" ? "bg-black" : "bg-white"} contentContainerClassName="pb-8">
        <View className="px-6 pt-2">
          ...
          <View className="mb-4 flex-row items-center">
            ...
            <Text className="ml-2 text-xl font-bold text-gray-900 dark:text-white">Settings</Text>
          </View>
          ...
          <ThemedView className="mb-4 rounded-xl p-2">
            ...
            <View className="h-px bg-gray-200 dark:bg-gray-700" />
            <SettingsRow
              icon={<HelpCircle size={18} color={theme === "dark" ? "#9CA3AF" : "#6B7280"} />}
              label="Help Center"
              onPress={openDocs}
            />
          </ThemedView>
