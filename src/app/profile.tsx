    ...
    >
      <View className="p-6">
        ...
        <View className="bg-white p-4 rounded-lg items-center mb-6">
          ...
          <TouchableOpacity onPress={handleSignOut} className="flex-row items-center mt-4">
        ...
        <View className="bg-white p-4 rounded-lg mb-6">
          <View className="flex-row items-center mb-2">
            ...
            <Text className="ml-2 font-bold">Recent Achievements</Text>
          </View>
          <Text className="text-gray-500 mb-4">
          ...
          <View className="gap-y-3">
            {achievements.map((achievement) => (
              <View key={achievement.id} className="flex-row items-center p-3 bg-gray-100 rounded-lg">
