        ...
        <View className="bg-white p-4 rounded-lg">
          ...
          <View className="flex-row gap-3">
            <TouchableOpacity className="flex-1 border border-gray-200 rounded-lg p-3 items-center">
              ...
              <Text className="ml-2 text-gray-500">View Events</Text>
            </TouchableOpacity>
            <TouchableOpacity className="flex-1 border border-gray-200 rounded-lg p-3 items-center">
              <MaterialIcons name="people" size={16} color="#6B7280" />
              <Text className="ml-2 text-gray-500">Projects</Text>
            </TouchableOpacity>
          </View>
          <View className="flex-row gap-3 mt-3">
            <TouchableOpacity className="flex-1 border border-gray-200 rounded-lg p-3 items-center">
              <MaterialIcons name="library-books" size={16} color="#6B7280" />
              <Text className="ml-2 text-gray-500">Resources</Text>
            </TouchableOpacity>
            <TouchableOpacity className="flex-1 border border-gray-200 rounded-lg p-3 items-center">
              <MaterialIcons name="person" size={16} color="#6B7280" />
              <Text className="ml-2 text-gray-500">Profile</Text>
            </TouchableOpacity>
          </View>
        </View>
